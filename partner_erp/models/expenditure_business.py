...
class ExpenditureBusiness(models.Model):
    """支出业务"""
    _name = 'partner.expenditure_business'
    _description = u"支出业务"
    ...
    budget_department_id = fields.Many2one('partner.budget_department', string=u'预算部门', readonly=True, states=READONLY)
    ...
    def unlink(self):
        ...
        if self.state == 'done' or self.state == 'confirm':
            ...
            return super(ExpenditureBusiness, self).unlink()
